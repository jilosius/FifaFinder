...
public class SpielerServiceTest {
    ...
    public void setUp() {
        ...
        SpielerDTO player1 = new SpielerDTO(
                1,23, "https://example.com/player1.jpg", "J. Doe", "John Doe", 25, "https://example.com/flag.png", "SpVgg Test" ,"https://example.com/club.png", 80, 85, "Forward", 1000000L,
                185, 75, "right", 80, 70, 80, 75, 80,
                70, 80, 75, 80, 70, 80, 75, 80, 70,
                80, 75, 80, 80, 50000L);
        SpielerDTO player2 = new SpielerDTO(
                2,23,"https://example.com/player2.jpg", "J. Smith", "Jane Smith", 22, "https://example.com/flag.png", "FC Test","https://example.com/club.png", 75, 90, "Midfielder", 500000L,
