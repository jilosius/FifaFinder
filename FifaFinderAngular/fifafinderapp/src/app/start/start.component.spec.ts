...
describe('DeletePlayer',() => {
  let component: StartComponent;
  let fixture: ComponentFixture<StartComponent>;
  let deletePlayerService: DeletePlayerService;
  let router: Router;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(StartComponent);
    component = fixture.componentInstance;
    deletePlayerService = TestBed.inject(DeletePlayerService);
  ...
  it('should utilize the service to delete a player', () =>{
    ...
    spyOn(deletePlayerService, "deletePlayer").and.returnValue(of('some value'));
    component.deleteAllLogic(1);
    expect(deletePlayerService.deletePlayer).toHaveBeenCalledOnceWith(1);
  });

  it('should cancel the deleteAll process', ()=>{
    spyOn(window, "confirm").and.returnValue(false);
    spyOn(component, "refresh");
    spyOn(deletePlayerService,"deletePlayer").and.returnValue(of('some value'));
    component.deleteAllLogic(1);
    expect(deletePlayerService.deletePlayer).not.toHaveBeenCalledOnceWith(1);
  });

  it('should cancel the deletePerFifaVersion process', ()=>{
    spyOn(window, "confirm").and.returnValue(false);
    spyOn(component, "refresh");
    spyOn(deletePlayerService,"deletePlayerInFifaVersion").and.returnValue(of('some value'));
    component.deletePerFifaVersionLogic(1,23);
    expect(deletePlayerService.deletePlayerInFifaVersion).not.toHaveBeenCalledOnceWith(1,23);
  });

  it('should utilize the service to delete a player for one fifaversion',()=>{
    spyOn(window,"confirm").and.returnValue(true);
    spyOn(component, "refresh");
    spyOn(deletePlayerService, "deletePlayerInFifaVersion").and.returnValue(of('some other value'));
    component.deletePerFifaVersionLogic(1,23);
    expect(deletePlayerService.deletePlayerInFifaVersion).toHaveBeenCalledOnceWith(1,23);
  });
  ...
  describe('ValuesControl', () => {
    ...
    it('should reset all values', () => {
      ...
      expect(component.clubFilter.value).toEqual('');
      expect(component.clubName).toEqual('');
